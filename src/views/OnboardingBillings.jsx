			...
			>
				<div className="w-full max-w-screen-xl">
					...
					<div className="w-[100%] mt-[5px] flex items-center justify-center">
						<div className="flex w-[200px] h-[40px]  border-[1px]   rounded-[4px] px-[3px] py-[3px]">
							<div
								onClick={() => {
									setSelected(0);
								}}
					...
					<div className="w-[100%] mt-[15px] gap-[20px] grid laptop:grid-cols-3">
						{planMockDataForOnBoarding.slice(0, 3).map((item, index) => {
							return (
								<div
									key={index}
									style={{
                  ...
                  >
                    {item?.desc}
									...
									>
										${item?.additionalPage?.price} per{" "}
										{item?.additionalPage?.pageCount} additional page views
									</p>
