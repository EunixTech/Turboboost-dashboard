...
const SettingPage = () => {
  // Define your initialValues, validation, and onSubmit function
  const initialValues = {
    firstName: "",
    lastName: "",
    country: "",
  ...
  const onSubmit = (values, { setSubmitting }) => {
    // You can perform your submission logic here, for example, sending data to a server.
    // You can access the form values through the 'values' object.

    // Simulate a submission (you can replace this with your actual submission logic)
    setTimeout(() => {
                ...
                >
                  ...
                  >
                    <div className="w-[100%] py-[10px]">
                      ...
                      <div className="w-[100%] mb-[10px] text-[10px] italic text-[#85858C] mt-[5px] ">
                        Choose the desired optimization image quality, from 0 to
                        100, Google recommends 80.
                      </div>
                    </div>
                  </FeatureCard>
                  ...
                  >
                    <div className="w-[100%] py-[10px]">
                      ...
                      />
                      <div className="w-[100%] mb-[10px] text-[10px] italic text-[#85858C] mt-[5px] ">
                        Images will get width and heiht pre-configured before
                        the actual image is loaded. Helps with some element
                        sizing issues
                      </div>
                      ...
                      />
                      <div className="w-[100%] mb-[10px] text-[10px] italic text-[#85858C] mt-[5px] ">
                        Some themes allow configuring an overlay for embedded
                        videos. With this setting enabled, TurboBoost will
                        display that overlay instead of the video thumbnail
                        before the video is loaded.
                      </div>

                      <InputFields labelText="Loading Threshold" type="text" />
                      <div className="w-[100%] mb-[10px] text-[10px] italic text-[#85858C] mt-[5px] ">
                        Elements approaching the viewport will be lazy loaded
                        when they get the configured threshold or close
                      </div>
                  ...
                  >
                    ...
                    >
                      <div className="w-[100%] py-[10px]">
                        ...
                        />
                        <div className="w-[100%] mb-[10px] text-[10px] italic text-[#85858C] mt-[5px] ">
                          Enabling this will use a single group for styles using
                          media “screen” and “all”. Otherwise 2 separate files
                          will be created for each group. In most cases this
                          setting must be enabled for best results.
                        </div>
                      </div>
                    </FeatureCard>
                  ...
                  >
                    ...
                    >
                      <div className="w-[100%] py-[10px]">
                        ...
                        />
                        <div className="w-[100%] mb-[10px] text-[10px] italic text-[#85858C] mt-[5px] ">
                          The HTTP method to use when TurboBoost is purging the
                          entire reverse proxy cache. Default value is PURGE.
                        </div>
                        ...
                        <div className="w-[100%] mb-[10px] text-[10px] italic text-[#85858C] mt-[5px] ">
                          List the IPs of the reverse proxy servers that should
                          get their cache purge.
                        </div>
                      </div>
                    </FeatureCard>
                    ...
                    >
                      <div className="w-[100%] py-[10px]">
                        ...
                        <div className="w-[100%] mb-[10px] text-[10px] italic text-[#85858C] mt-[5px] ">
                          The Sucuri API key for http://txtcartapp.com/, labeled
                          as API_KEY in the website Firewall Dashboard
                        </div>
