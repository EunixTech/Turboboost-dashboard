      ...
      <div className="w-[100%] px-[20px] py-[10px]">
              ...
              <g id="user-01">
                <g id="Solid">
                  <path
                    fill-rule="evenodd"
                    clip-rule="evenodd"
                    d="M6.5895 10.875C8.1965 10.8753 9.8035 10.8753 11.4105 10.875C11.9555 10.8749 12.3269 10.8748 12.6512 10.932C14.2037 11.2057 15.4193 12.4213 15.693 13.9738C15.7502 14.2981 15.7501 14.6695 15.75 15.2145C15.75 15.3333 15.7536 15.4529 15.7329 15.5704C15.6508 16.0361 15.2861 16.4008 14.8204 16.4829C14.7182 16.5009 14.6106 16.5003 14.5571 16.5001C10.8528 16.4802 7.14725 16.4802 3.44288 16.5001C3.38936 16.5003 3.28177 16.5009 3.17964 16.4829C2.71388 16.4008 2.34922 16.0361 2.26709 15.5704C2.24637 15.4529 2.25001 15.3333 2.24999 15.2145C2.24987 14.6695 2.24978 14.2981 2.30697 13.9738C2.58073 12.4213 3.79627 11.2057 5.34881 10.932C5.67312 10.8748 6.0445 10.8749 6.5895 10.875Z"
                    fill="#DBDBDB"
                  />
                  <path
                    fill-rule="evenodd"
                    clip-rule="evenodd"
                    d="M4.875 5.625C4.875 3.34683 6.72182 1.5 9 1.5C11.2782 1.5 13.125 3.34683 13.125 5.625C13.125 7.90317 11.2782 9.75 9 9.75C6.72182 9.75 4.875 7.90317 4.875 5.625Z"
                    fill="#DBDBDB"
                  />
                </g>
              </g>
          ...
          src={
            ...
            >
              <g id="google-chrome">
                <g id="Solid">
                  <path
                    d="M5.53185 7.57107L3.46951 4.11221C3.30436 3.83523 3.22179 3.69675 3.20318 3.53745C3.18806 3.40809 3.21519 3.24477 3.27131 3.12724C3.34041 2.98251 3.44797 2.89118 3.66309 2.70852C5.10175 1.48694 6.96481 0.75 9 0.75C11.8555 0.75 14.3722 2.20076 15.8532 4.40542C16.0167 4.64884 16.0985 4.77055 16.0913 4.89643C16.0854 4.99987 16.026 5.11123 15.9434 5.17383C15.843 5.25 15.6853 5.25 15.3699 5.25H9C7.4349 5.25 6.09374 6.2088 5.53185 7.57107Z"
                    fill="#DBDBDB"
                  />
                  <path
                    d="M0.75 9C0.75 7.73353 1.03537 6.53372 1.54532 5.46135C1.67099 5.19707 1.73383 5.06492 1.84561 5.00689C1.93747 4.95919 2.06336 4.95329 2.15928 4.99217C2.276 5.03948 2.35663 5.17471 2.51788 5.44516L5.69648 10.7762C6.32964 11.9513 7.57155 12.75 9 12.75C9.15395 12.75 9.30573 12.7407 9.45481 12.7227L7.44861 16.2188C7.28828 16.4981 7.20812 16.6378 7.07832 16.7321C6.97303 16.8086 6.81704 16.8651 6.68718 16.8737C6.52709 16.8844 6.39512 16.8354 6.13118 16.7375C2.98912 15.5721 0.75 12.5475 0.75 9Z"
                    fill="#DBDBDB"
                  />
                  <path
                    d="M8.79513 16.886C8.70221 17.0479 8.81332 17.25 9 17.25C13.5563 17.25 17.25 13.5563 17.25 9C17.25 8.53511 17.2115 8.07921 17.1377 7.63529C17.0914 7.35742 17.0683 7.21848 16.9794 7.08478C16.9073 6.97632 16.7807 6.86904 16.6618 6.81572C16.5154 6.75 16.3542 6.75 16.0318 6.75H12.0003C12.471 7.37675 12.75 8.1558 12.75 9C12.75 9.73466 12.5387 10.42 12.1737 10.9985L8.79513 16.886Z"
                    fill="#DBDBDB"
                  />
                  <path
        ...
        <Item
          onClick={() => {
            setOpen(false);
            window.open(
              "https://platform.shoffi.app/signup/affiliate?app=Il_GWiJgvzW",
              "_blank"
            );
          }}
          src={
