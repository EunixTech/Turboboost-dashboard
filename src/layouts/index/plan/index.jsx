...
import convertFloatToInt from "../../../utils/convertFloatToInt.js";
          ...
          <div className="laptop:w-[68%] mobile:w-[100%] ">
            {planMockData?.map((item, index) => {
              ...
              >
                ...
                >
                  {selected === 0 ? `$${item?.monthlyPrice}` : `$${(item?.annuallyPrice / 12).toFixed(1) && convertFloatToInt((item?.annuallyPrice / 12).toFixed(1))}`}
